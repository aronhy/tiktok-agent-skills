...
1. 确认输入是公开 TikTok **个人主页/账号 URL**，而非单条视频、店铺、搜索页或仅有昵称。规范化 URL 与 Handle；无法可靠提取时，只问一个问题，请用户提供主页链接。
2. 记录可选条件：市场、日期窗口、最多视频数、运营目标和对标账号。未提供时使用工作流中的默认范围，并明确披露该默认值。
...
- 使用报告模板的固定顺序，结果前置。
- 标明规范化 Handle、采样范围、来源账本、假设、未公开/读取失败字段和 A/B/C 可信度。
